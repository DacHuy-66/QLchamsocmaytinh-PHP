                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="Themlh.php" class="btn btn-primary" style="color: aliceblue;">Thêm</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row["malh"] . "</td>";
                                                echo "<td>" . $row["makh"] . "</td>";
                                                echo "<td>" . $row["manvchamsockh"] . "</td>";
                                                echo "<td>" . $row["ngayhen"] . "</td>";
                                                echo "<td>" . $row["trangthai"] . "</td>";

                                                // Edit and Delete buttons
                                                echo '<td>
                                                <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["malh"] . ')">Sửa</button>
                                                <button class="btn btn-danger btn-sm" onclick="deleteCustomer(' . $row["malh"] . ')">Xóa</button>
                                                </td>';
