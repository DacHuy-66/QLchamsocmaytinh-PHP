...
if (isset($_GET['madv']) && is_numeric($_GET['madv'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $conn->prepare("UPDATE danhmucdichvu SET tendv = ?, mota = ?, dongia = ? WHERE madv = ?");
        $stmt->bind_param("sssi", $tendv, $mota, $dongia, $madv);
    ...
    $sql = "SELECT * FROM danhmucdichvu WHERE madv = ?";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sửa thông tin dịch vụ</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <input type="text" name="tendv" value="<?= $dichvu['tendv'] ?>" required><br>

                            <label for="mota">Mô tả:</label>
                            <input type="text" name="mota" value="<?= $dichvu['mota'] ?>" required><br>

                            <label for="dongia">Đơn giá:</label>
                            <input type="text" name="dongia" value="<?= $dichvu['dongia'] ?>" required><br>
