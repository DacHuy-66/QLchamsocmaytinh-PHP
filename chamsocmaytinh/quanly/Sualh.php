...
if (isset($_GET['malh']) && is_numeric($_GET['malh'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $makh = $_POST['makh'];
        $manvchamsockh = $_POST['manvchamsockh'];
        $ngayhen = $_POST['ngayhen'];
        $trangthai = $_POST['trangthai'];

        // Prepare and bind the UPDATE statement
        $stmt = $conn->prepare("UPDATE lichhen SET makh = ?, manvchamsockh = ?, ngayhen = ?, trangthai = ? WHERE makh = ?");
        $stmt->bind_param("ssssi", $makh, $manvchamsockh, $ngayhen, $trangthai, $malh);
    ...
    $sql = "SELECT * FROM lichhen WHERE malh = ?";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sửa thông tin lịch hẹn</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <input type="text" name="makh" value="<?= $lichhen['makh'] ?>" required><br>

                            <label for="manvchamsockh">Mã nhân viên chăm sóc:</label>
                            <input type="text" name="manvchamsockh" value="<?= $lichhen['manvchamsockh'] ?>" required><br>

                            <label for="ngayhen">Ngày hẹn:</label>
                            <input type="text" name="ngayhen" value="<?= $lichhen['ngayhen'] ?>" required><br>

                            <label for="trangthai">Trạng thái:</label>
                            <input type="text" name="trangthai" value="<?= $lichhen['trangthai'] ?>" required><br>
