...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO lichhen (makh, manvchamsockh, ngayhen, trangthai) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param("ssss", $makh, $manvchamsockh, $ngayhen, $trangthai);
    $stmt->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Thêm lịch hẹn</h1>
                    ...
                    <div class="card shadow mb-4">
                        <form method="post" action="">
                            ...
                            <input type="text" name="manvchamsockh" required><br>

                            <label for="ngayhen">Ngày hẹn:</label>
                            <input type="text" name="ngayhen" required><br>
                            ...
                            <a href="lichhen.php" class="btn btn-secondary">Quay lại</a>
