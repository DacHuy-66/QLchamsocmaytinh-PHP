    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="Themkh.php" class="btn btn-primary" style="color: aliceblue;">Thêm</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td>
                                                <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["makh"] . ')">Sửa</button>
        ...
        <script>
            function editCustomer(makh) {
                ...
                window.location.href = 'Suakh.php?makh=' + makh;
            }
            ...
            function deleteCustomer(makh) {
                if (confirm('Bạn có chắc chắn muốn xóa khách hàng này?')) {
                    ...
                    // Example using window.location.href:
                    window.location.href = 'XoaKhachHang.php?makh=' + makh;
                }
            }
        </script>
</body>
