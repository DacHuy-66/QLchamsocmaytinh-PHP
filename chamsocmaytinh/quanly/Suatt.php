...
if (isset($_GET['matt']) && is_numeric($_GET['matt'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $manvthuchientt = $_POST['manvthuchientt'];
        $thanhtien = $_POST['thanhtien'];
        $ngaytt = $_POST['ngaytt'];
        $malh = $_POST['malh'];

        // Prepare and bind the UPDATE statement
        $stmt = $conn->prepare("UPDATE thanhtoan SET manvthuchientt = ?, thanhtien = ?, ngaytt = ?, malh = ? WHERE matt = ?");
        $stmt->bind_param("ssssi", $manvthuchientt, $thanhtien, $ngaytt, $malh, $matt);
    ...
    $sql = "SELECT * FROM thanhtoan WHERE matt = ?";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sửa thông tin thanh toán</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <label for="manvthuchientt">Mã nhân viên:</label>
                            <input type="text" name="manvthuchientt" value="<?= $thanhtoan['manvthuchientt'] ?>" required><br>

                            <label for="thanhtien">Thành tiền:</label>
                            <input type="text" name="thanhtien" value="<?= $thanhtoan['thanhtien'] ?>" required><br>

                            <label for="ngaytt">Ngày thanh toán:</label>
                            <input type="text" name="ngaytt" value="<?= $thanhtoan['ngaytt'] ?>" required><br>

                            <label for="malh">Mã lịch hẹn:</label>
                            <input type="text" name="malh" value="<?= $thanhtoan['malh'] ?>" required><br>
