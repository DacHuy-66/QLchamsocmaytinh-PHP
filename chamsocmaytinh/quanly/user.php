...
<body id="page-top">
    ...
    <div id="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="ThemUser.php" class="btn btn-primary" style="color: aliceblue;">Thêm</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td>
                                                <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["mand"] . ')">Sửa</button>
                                                <button class="btn btn-danger btn-sm" onclick="deleteCustomer(' . $row["mand"] . ')">Xóa</button>
                                                </td>';
        ...
        <script>
            function editCustomer(mand) {
                window.location.href = 'SuaUser.php?mand=' + mand;
            }

            function deleteCustomer(mand) {
                if (confirm('Bạn có chắc chắn muốn xóa user này?')) {
                    window.location.href = 'XoaUser.php?mand=' + mand;
                }
            }
        </script>
</body>
