        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Danh sách Phản hồi</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <!-- <button id="addButton" class="btn btn-primary">
                                <a href="Themph.php" style="color: aliceblue;">
                                    Thêm
                            </button></a> -->
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                // echo '<td>
                                                // <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["maph"] . ')">Sửa</button>
                                                // <button class="btn btn-danger btn-sm" onclick="deleteCustomer(' . $row["maph"] . ')">Xóa</button>
                                                // </td>';
