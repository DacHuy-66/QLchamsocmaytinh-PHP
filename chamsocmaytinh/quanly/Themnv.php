...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO nhanvien (tennv, sdt, chucvu, mand) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param("ssss", $tennd, $sdt, $chucvu, $mand);
    $stmt->execute();
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <form method="post" action="">
                            ...
                            <input type="text" name="tennv" required><br>

                            <label for="sdt">SĐT:</label>
                            <input type="text" name="sdt" required><br>

                            <label for="chucvu">Chức vụ:</label>
                            <input type="text" name="chucvu" required><br>

                            <label for="mand">Mã người dùng:</label>
                            <input type="text" name="mand" required><br>
