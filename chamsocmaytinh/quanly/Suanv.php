...
if (isset($_GET['manv']) && is_numeric($_GET['manv'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $conn->prepare("UPDATE nhanvien SET tennv = ?, sdt = ?, chucvu = ?, mand = ? WHERE manv = ?");
        $stmt->bind_param("ssssi", $tennv, $sdt, $chucvu, $mand, $manv);
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <input type="text" name="tennv" value="<?= $nhanvien['tennv'] ?>" required><br>

                            <label for="sdt">SDT:</label>
                            <input type="text" name="sdt" value="<?= $nhanvien['sdt'] ?>" required><br>

                            <label for="chucvu">Chức vụ:</label>
                            <input type="text" name="chucvu" value="<?= $nhanvien['chucvu'] ?>" required><br>

                            <label for="mand">Mã người dùng:</label>
                            <input type="text" name="mand" value="<?= $nhanvien['mand'] ?>" required><br>
