...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO thanhtoan (manvthuchientt, thanhtien, ngaytt, malh) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param("ssss", $manvthuchientt, $thanhtien, $ngaytt, $malh);
    $stmt->execute();

    // Redirect to the original page after insertion
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Thêm thanh toán</h1>


                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <form method="post" action="">
                            <!-- Add form fields for inputting new data -->
                            <label for="manvthuchientt">Mã nhân viên thực hiện:</label>
                            <input type="text" name="manvthuchientt" required><br>

                            <label for="thanhtien">Thành tiền:</label>
                            <input type="text" name="thanhtien" required><br>

                            <label for="ngaytt">Ngày thanh toán:</label>
                            <input type="text" name="ngaytt" required><br>

                            <label for="malh">Mã lịch hẹn:</label>
                            <input type="text" name="malh" required><br>

                            <!-- Add more form fields for other data -->

                            <button id="addButton" class="btn btn-primary" type="submit">Lưu</button>
