            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="Themnv.php" class="btn btn-primary" style="color: aliceblue;">Thêm</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo '<td>
                                                <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["manv"] . ')">Sửa</button>
                                                <button class="btn btn-danger btn-sm" onclick="deleteCustomer(' . $row["manv"] . ')">Xóa</button>
                                                </td>';
