...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $malh = $_POST["malh"];
    $madv = $_POST["madv"];
    $soluongdv = $_POST["soluongdv"];
    $manv = $_POST["manv"];
    
    // Perform the database insertion
    $insertSql = "INSERT INTO lichhendichvu (malh, madv, soluongdv, manv) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param("ssss", $malh, $madv, $soluongdv, $manv);
    $stmt->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Thêm lịch hẹn dịch vụ</h1>
                    ...
                    <div class="card shadow mb-4">
                        <form method="post" action="">
                            ...
                            <input type="text" name="madv" required><br>

                            <label for="soluongdv">Số lượng dịch vụ:</label>
                            <input type="text" name="soluongdv" required><br>
                            ...
                            <a href="lichhendv.php" class="btn btn-secondary">Quay lại</a>
