                    ...
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="user" action="dangkyDB.php" method="post">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control form-control-user" name="username" placeholder="Tên đăng nhập" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <?php if (isset($_GET['thongbao'])) { ?>
                                        <p class="thongbao"><?php echo $_GET['thongbao']; ?></p>
                                    <?php } ?>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="login.php">Bạn đã có tài khoản? Đăng nhập!</a>
                                </div>
                            </div>
                        </div>
                    </div>
