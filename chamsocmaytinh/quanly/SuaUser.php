...
if (isset($_GET['mand']) && is_numeric($_GET['mand'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $stmt = $conn->prepare("UPDATE user SET role = ?, username = ?, password = ? WHERE mand = ?");
        $stmt->bind_param("sssi", $role, $username, $password, $mand);
    ...
    $sql = "SELECT * FROM user WHERE mand = ?";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Sửa thông tin user</h1>
