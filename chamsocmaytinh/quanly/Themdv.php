...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO danhmucdichvu (tendv, mota, dongia) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($insertSql);
    $stmt->bind_param("sss", $tendv, $mota, $dongia);
    $stmt->execute();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Thêm dịch vụ</h1>
