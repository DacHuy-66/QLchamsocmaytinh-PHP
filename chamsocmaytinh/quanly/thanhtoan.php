        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Danh sách Thanh toán</h1>


                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        <a href="Themtt.php" class="btn btn-primary" style="color: aliceblue;">Thêm</a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td>" . $row["matt"] . "</td>";
                                                echo "<td>" . $row["manvthuchientt"] . "</td>";
                                                echo "<td>" . number_format($row["thanhtien"]) . "</td>";
                                                echo "<td>" . $row["ngaytt"] . "</td>";
                                                echo "<td>" . $row["malh"] . "</td>";

                                                // Edit and Delete buttons
                                                echo '<td>
                                                <button class="btn btn-primary btn-sm" onclick="editCustomer(' . $row["matt"] . ')">Sửa</button>
                                                </td>';
